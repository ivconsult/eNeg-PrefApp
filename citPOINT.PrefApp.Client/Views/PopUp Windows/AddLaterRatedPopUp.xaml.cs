...
namespace citPOINT.PrefApp.Client
{
    ...
    /// </summary>
    public partial class AddLaterRatedPopUp : UserControl, ICleanup
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddOptionPopUp"/> class.
        /// </summary>
        public AddLaterRatedPopUp()
        {
            InitializeComponent();
        }
        ...
        private void UserControl_KeyDown(object sender, System.Windows.Input.KeyEventArgs e)
        {
            ...
            {
                uxcmdAddOption.Focus();
                Dispatcher.BeginInvoke(() => { uxcmdAddOption.Command.Execute(uxcmdAddOption.CommandParameter); });
            }
        }
