...
{
    /// <summary>
    /// View appear as a content in PopUp Window when user want to publish one of his sets to set store
    /// </summary>
    public partial class PublishToSetStorePopUp : UserControl, ICleanup
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PublishToSetStorePopUp"/> class.
        /// </summary>
        public PublishToSetStorePopUp()
        {
            InitializeComponent();
        }
